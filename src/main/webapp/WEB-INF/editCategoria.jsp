...
<div class="container col-md-4 mb-5">
		...
		<br>
		<form:form action="/categoria/update" method="POST" class="px-2" modelAttribute="categoria">
			<form:hidden path="id"/>
			<div class="form-group">
				<form:label path="nombre">Categoria</form:label> <form:input class="form-control" path="nombre"/>
				<br>
			</div>
